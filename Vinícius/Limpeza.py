...
def tokenizer(texto):
	...
	# textoSemEmoji = removeemoji(textoLower)#remove os emojis	
	# text = tt.tokenize(textoSemEmoji)#tokeniza o texto		
...
#remove as stopwords, recebe uma lista de palavras, e steming
def remover_stopwords (lista):
	...
	novaListaSteemer = []#nova lista para receber as palavras com o stemização
	for palavra in novaLista:#varre a lista
		novaListaSteemer.append(stemizacao(palavra))#Faz a stemização
